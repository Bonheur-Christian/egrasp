  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-primary data-active:text-white rounded-full dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
