...
import { Search, TrendingUp, Users, Clock, Star, Plus } from "lucide-react";
...
export default function Courses() {
  ...
  const trending = useMemo(() => courses.filter((c) => c.trending), []);
  ...
  const filtered = useMemo(() => {
    ...
    if (priceFilter !== "all")
      list = list.filter((c) => c.type === priceFilter);
    ...
    return list;
  }, [search, selectedCategory, sort, priceFilter]);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative overflow-hidden bg-primary">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <p className="text-primary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
            Learn new skills from industry experts. Find the perfect course to
            advance your career.
          </p>
      ...
      <div className="max-w-[90%] mx-auto px-12 py-10">
          ...
          <section className="mb-12">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-foreground flex items-center gap-2">
                <TrendingUp className="h-5 w-5 text-primary" /> Trending Courses
              </h2>
            </div>
            <Carousel
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2 mb-6">
              {(["all", "free", "paid"] as PriceFilter[]).map((t) => (
                <Badge
                  key={t}
                  variant={priceFilter === t ? "default" : "outline"}
                  className="cursor-pointer capitalize"
                  onClick={() => setPriceFilter(t)}
                >
                  {t}
                </Badge>
              ))}
          ...
          <aside className="hidden lg:block w-72 flex-shrink-0 space-y-6">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {c.rating} ({c.students.toLocaleString()} students)
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="rounded-xl bg-primary p-5 text-primary-foreground">
              ...
              <p className="text-sm text-primary-foreground/80 mb-4">
                Create a course and teach thousands of learners.
              </p>
              <Button
                variant="secondary"
                size="lg"
        ...
        <section className="lg:hidden mt-12 rounded-xl bg-primary p-6 text-primary-foreground text-center">
          <h3 className="font-bold text-lg mb-2">Share Your Expertise</h3>
          <p className="text-sm text-primary-foreground/80 mb-4">
            Create a course and teach thousands of learners.
          </p>
